...
REASONING_CHAT_SYSTEM = (
    ...
    "Each line must be a concrete text-to-image prompt for a CLOSE-UP HAIR TEXTURE SAMPLE — "
    "no faces, no people, no portraits. Focus purely on the hair color and texture "
    ...
    "Use rich descriptors for color, finish, and texture — these become color reference images for the edit.\n\n"
